...
namespace NattiPress\NattiCore\Bolt;
...
class Bolt
{
    public function make(array $args)
    {
        ...
        if ($action == 'make:plugin') {
            ...
            $plugin_file_source = 'NattiCore/Bolt/samples/plugin-sample.php';
            ...
            $controller_file_source = 'NattiCore/Bolt/samples/controller-sample.php';
            ...
            $view_file_source = 'NattiCore/Bolt/samples/view-sample.php';
            ...
            $js_file_source = 'NattiCore/Bolt/samples/js-sample.js';
            ...
            $css_file_source = 'NattiCore/Bolt/samples/css-sample.css';
            ...
            $config_file_source = 'NattiCore/Bolt/samples/config-sample.json';
		...
		if ($action == 'make:migration') {
            ...
            $file_sample = 'NattiCore/Bolt/samples/migration-sample.php';
		...
		if ($action == 'make:model') {
            ...
            $file_sample = 'NattiCore/Bolt/samples/model-sample.php';
            if (!file_exists($file_sample))
    ...
    public function migrate(array $args)
    {
        ...
        if ($action == 'migrate' || $action == 'migrate:rollback') {
            $folder = 'themes/' . $folder . '/migrations/';
	...
	Bolt v$version Command Line Tool
